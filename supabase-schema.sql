...
-- Add RLS policies for success_votes
...
-- Add indexes for success_votes
CREATE INDEX IF NOT EXISTS idx_success_votes_prompt_id ON public.success_votes(prompt_id);
CREATE INDEX IF NOT EXISTS idx_success_votes_user_id ON public.success_votes(user_id);
CREATE INDEX IF NOT EXISTS idx_success_votes_vote_type ON public.success_votes(vote_type);
...
-- Create triggers for success stats
...
-- Version History & Forking Tables
...
-- Add version and fork fields to prompts table
...
-- Add indexes for version history and forking
...
CREATE INDEX IF NOT EXISTS idx_prompt_forks_original_prompt_id ON public.prompt_forks(original_prompt_id);
CREATE INDEX IF NOT EXISTS idx_prompt_forks_forked_by ON public.prompt_forks(forked_by);
